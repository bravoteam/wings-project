...
Public Class ImprimirBoleta
    ...
    Private Sub ImprimirBoleta_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            Me.promedioTableAdapter.Fill(Me.acreditacionDataSet.promedio, Calificacion.DG(1, Calificacion.DG.CurrentCell.RowIndex).Value.ToString)
            ...
            Me.boletaTableAdapter.Fill(Me.acreditacionDataSet.boleta, Calificacion.DG(1, Calificacion.DG.CurrentCell.RowIndex).Value.ToString)
