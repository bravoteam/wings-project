...
Partial Public Class acreditacionDataSet
    ...
    Partial Public Class boletaDataTable
        ...
        Public Overloads Function AddboletaRow( _
                    ...
                    ByVal nombre1 As String) As boletaRow
            Dim rowboletaRow As boletaRow = CType(Me.NewRow,boletaRow)
            Dim columnValuesArray() As Object = New Object() {idcampus, idturno, nombre, apellido_paterno, apellido_materno, curp, matricula, idsemestre, idgrupo, generacion, idespecialidad, idlicenciatura, Matricula1, IDMAESTRO, IDMATERIA, CALIFICACION, IDPARCIAL, IDSEMESTRE1, IDLICENCIATURA1, ESTADO, IDCICLOESCOLAR, IDGRUPO1, calificacion2, extra1, extra2, extra3, extra4, extra1_fecha, extra2_fecha, extra3_fecha, extra4_fecha, idcicloescolar1, nombre1}
