...
Public Class Reporte_Oportunidades_Regularizacion
    Private Sub pdf()
        ...
        Try
            ...
            ReportViewer1.LocalReport.ReportPath = "Reporte_Oportunidades_Regularizacion.rdl"
            Dim fs As New FileStream("C:\ISENCO\" & "Reporte_Oportunidades_Regularizacion" & ".pdf", FileMode.Create)
            fs.Write(bytes, 0, bytes.Length)
            fs.Close()
            Process.Start("C:\ISENCO\" & "Reporte_Oportunidades_Regularizacion" & ".pdf")
        Catch EX As Exception
            MsgBox(EX.ToString)
        End Try
    End Sub
    Private Sub Reporte_Oportunidades_Regularizacion_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'ReportesDT.Mujeres' table. You can move, or remove it, as needed.
        ...
        Me.OPORTUNIDADESREGULARIZACIONTableAdapter.Fill(Me.ReportesDT.OPORTUNIDADESREGULARIZACION, FrmMain.cmbEspecialidad.Text, FrmMain.cmbSemestre.Text, FrmMain.cmbGrupo.Text, FrmMain.cmbCampus.Text, IdLice, FrmMain.cmbTurno.Text, FrmMain.cmbModalidad.Text)
