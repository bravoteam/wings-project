...
Public Class Reporte_Actividades_Deportivas
    Private Sub pdf()
        ...
        Try
            ...
            ReportViewer1.LocalReport.ReportPath = "Reporte_Actividades_cult_deport.rdl"
        ...
        End Try
    End Sub
    Private Sub Reporte_Actividades_Deportivas_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Me.Actividades_culturales_deportivasTableAdapter.Fill(Me.ReportesDT.Actividades_culturales_deportivas, FrmMain.cmbEspecialidad.Text, FrmMain.cmbSemestre.Text, FrmMain.cmbGrupo.Text, FrmMain.cmbCampus.Text, IdLice, FrmMain.cmbTurno.Text, FrmMain.cmbModalidad.Text)
    ...
    Private Sub GenerarPDFToolStripMenuItem1_Click(sender As System.Object, e As System.EventArgs) Handles GenerarPDFToolStripMenuItem1.Click
