...
Public Class Reporte_Segunda_Oportunidad
    Private Sub pdf()
        ...
        End Try
    End Sub
    Private Sub Reporte_Segunda_Oportunidad_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Me.Segunda_OportunidadTableAdapter.Fill(Me.ReportesDT.Segunda_Oportunidad, FrmMain.cmbEspecialidad.Text, FrmMain.cmbSemestre.Text, FrmMain.cmbGrupo.Text, FrmMain.cmbCampus.Text, IdLice, FrmMain.cmbTurno.Text, FrmMain.cmbModalidad.Text)
