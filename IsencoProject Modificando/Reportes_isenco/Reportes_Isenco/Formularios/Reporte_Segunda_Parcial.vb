...
Public Class Reporte_Segunda_Parcial
    Private Sub pdf()
        ...
        Try
            ...
            ReportViewer1.LocalReport.ReportPath = "Reporte_Segunda_Parcial.rdl"
            Dim fs As New FileStream("C:\ISENCO\" & "Reporte_Segunda_Parcial" & ".pdf", FileMode.Create)
            fs.Write(bytes, 0, bytes.Length)
            fs.Close()
            Process.Start("C:\ISENCO\" & "Reporte_Segunda_Parcial" & ".pdf")
