...
Public Class Reporte_Tercera_Oportunidad
    Private Sub pdf()
        ...
        Try
            ...
            ReportViewer1.LocalReport.ReportPath = "Reporte_Segunda_Oportunidad.rdl"
            Dim fs As New FileStream("C:\ISENCO\" & "Reporte_Segunda_Oportunidad" & ".pdf", FileMode.Create)
            fs.Write(bytes, 0, bytes.Length)
            fs.Close()
            Process.Start("C:\ISENCO\" & "Reporte_Segunda_Oportunidad" & ".pdf")
    ...
    Private Sub Reporte_Tercera_Oportunidad_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Me.Tercera_OportunidadTableAdapter.Fill(Me.ReportesDT.Tercera_Oportunidad, FrmMain.cmbEspecialidad.Text, FrmMain.cmbSemestre.Text, FrmMain.cmbGrupo.Text, FrmMain.cmbCampus.Text, IdLice, FrmMain.cmbTurno.Text, FrmMain.cmbModalidad.Text)
