...
Partial Class Reporte_Oportunidades_Regularizacion
    ...
    Private Sub InitializeComponent()
        ...
        Me.OPORTUNIDADESREGULARIZACIONBindingSource = New System.Windows.Forms.BindingSource(Me.components)
        ...
        Me.OPORTUNIDADESREGULARIZACIONTableAdapter = New Reportes_Isenco.ReportesDTTableAdapters.OPORTUNIDADESREGULARIZACIONTableAdapter()
        ...
        CType(Me.OPORTUNIDADESREGULARIZACIONBindingSource, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        '
        'OPORTUNIDADESREGULARIZACIONBindingSource
        '
        Me.OPORTUNIDADESREGULARIZACIONBindingSource.DataMember = "OPORTUNIDADESREGULARIZACION"
        Me.OPORTUNIDADESREGULARIZACIONBindingSource.DataSource = Me.ReportesDT
        '
        'MenuStrip1
        '
        ...
        ReportDataSource5.Value = Me.OPORTUNIDADESREGULARIZACIONBindingSource
        Me.ReportViewer1.LocalReport.DataSources.Add(ReportDataSource1)
        Me.ReportViewer1.LocalReport.DataSources.Add(ReportDataSource2)
        Me.ReportViewer1.LocalReport.DataSources.Add(ReportDataSource3)
        Me.ReportViewer1.LocalReport.DataSources.Add(ReportDataSource4)
        Me.ReportViewer1.LocalReport.DataSources.Add(ReportDataSource5)
        Me.ReportViewer1.LocalReport.ReportEmbeddedResource = "Reportes_Isenco.Reporte_Oportunidades_Regularizacion.rdlc"
        Me.ReportViewer1.Location = New System.Drawing.Point(20, 45)
        ...
        '
        'OPORTUNIDADESREGULARIZACIONTableAdapter
        '
        Me.OPORTUNIDADESREGULARIZACIONTableAdapter.ClearBeforeFill = True
        '
        'Reporte_Oportunidades_Regularizacion
        '
        ...
        Me.Name = "Reporte_Oportunidades_Regularizacion"
        Me.Text = "Reporte Acreditados x Oportunidad"
        ...
        CType(Me.OPORTUNIDADESREGULARIZACIONBindingSource, System.ComponentModel.ISupportInitialize).EndInit()
    ...
    Friend WithEvents OPORTUNIDADESREGULARIZACIONBindingSource As System.Windows.Forms.BindingSource
    ...
    Friend WithEvents OPORTUNIDADESREGULARIZACIONTableAdapter As Reportes_Isenco.ReportesDTTableAdapters.OPORTUNIDADESREGULARIZACIONTableAdapter
End Class
