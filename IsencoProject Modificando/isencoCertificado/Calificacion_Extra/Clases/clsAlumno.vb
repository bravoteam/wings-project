    ...
    Public Class AlumnosModel
        ...
        Public Function getCalificacionesAlumno(ByVal Matricula As String) As DataSet
            ...
            sql = "SELECT " & _
                  ...
                  "ISNULL(C.EXTRA1, '0') AS 'EXTRA 1', " & _
                  "ISNULL(C.EXTRA2, '0') AS 'EXTRA 2', " & _
                  "ISNULL(C.EXTRA3, '0') AS 'EXTRA 3', " & _
                  "ISNULL(C.EXTRA4, '0') AS 'EXTRA 4' " & _
        ...
        Public Function getEspecialidades() As List(Of String)
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                For Each f As DataRow In ds.Tables(0).Rows
                    Especialidades.Add(f("ESPECIALIDAD").ToString)
                Next
            Else
