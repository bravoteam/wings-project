    ...
    Public Class Buscar
        ...
        Public Sub getBusquedaResultados(ByVal SentenciaSQL As String, ByVal ParametroBuscar As String)
            ...
            For i = 0 To CantidadCampos
                frmBuscar.Grid.Columns.Add(dr.GetName(i).ToString.ToUpper, dr.GetName(i).ToString.ToUpper)
            Next
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                i = 0
                frmBuscar.Grid.Rows.Add(ds.Tables(0).Rows.Count)
                For Each f As DataRow In ds.Tables(0).Rows
                    For Each c As DataColumn In ds.Tables(0).Columns
                        'campos_regreso
                        frmBuscar.Grid(j, i).Value = f(c).ToString
                        j += 1
            ...
            frmBuscar.Grid.Columns(CantidadCampos).Visible = False
