...
Public Class Rpt_ReprobadasFrm
    ...
    Private Sub consultarcmd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles consultarcmd.Click
        If ChkRptgral.Checked = True Then
            ...
            Me.Reporte_GeneralTableAdapter.Fill(Me.DataSet1.Reporte_General)
            Me.ReportViewer1.RefreshReport()
        Else
            Me.ReportViewer1.Visible = False
            Me.ReportViewer2.Visible = True
            Me.Reporte_EspecificoTableAdapter.Fill(Me.DataSet1.Reporte_Especifico, cmbSemestre.Text, cmbLicenciatura.Text, cmbCampus.Text, cmbEspecialidad.Text, cmdGrupo.Text, cmbTurno.Text)
