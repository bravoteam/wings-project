...
Public Class variables
    ...
    Public Shared valor1_extra As Integer
    Public Shared valor2_extra As Integer
    Public Shared valor3_extra As Integer
    Public Shared valor4_extra As Integer
    Public Shared valor5_extra As Integer
